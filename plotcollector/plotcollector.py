...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def change_fig(self):
        ...
        alias = self.aliases_dict[text]
        figure = self.fig_dict[alias][0]
        self.remove_canvas()
        self.add_canvas(figure)
    ...
    def file_save(self):
        ...
        save_path, extension = QtWidgets.QFileDialog.getSaveFileName(
            self, 'Save File', "Figures", extensions)
        ...
        if extension == "PDF(*.pdf)":
            ...
            QtWidgets.QMessageBox.about(
                self, "Save File", "PowerPoint Presentation saved.")
        else:
            pass
